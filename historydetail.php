          ...
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              <?php
                ...
                $id = $_SESSION['id']; 
                $eyedee = $_GET['id'];
                $sql = "SELECT * FROM order_details a left JOIN tb_product c on c.product_code = a.product_code left join tb_image on c.product_code = tb_image.product_id WHERE a.order_id = $eyedee;";
                $stmt = $conn->query($sql);
                $grand_total = 0;
                while ($row = $stmt->fetch_assoc()):
              ?>
              ...
              <?php endwhile; ?>
              <a href="history.php"><button class="btn btn-danger"> ย้อนกลับ</button></a>
              <!-- <tr>
                <td colspan="3">
