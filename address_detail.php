...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <br>
                <h1 align="center">A D D R E S</h1>
                <br>
                <form>
            <div class="form-group row">
                <?php
                $sql = "select * from tb_address WHERE cus_id = '".$_SESSION['id']."' ";
                ...
                <table class="table">
                    ...
                    <?php $i=0; while($row = $result->fetch_assoc()){ $i += 1 ?>
                    <tr>
                        <td><?=$i ?></td>
                        <td><?= $row['address'] ?></td>
                        <td width="400"></td>
                        <td width=""><a href="remove_address.php?id=<?= $row['address_id'] ?>"><button class="btn btn-danger" >ลบ</button></a></td>
                    </tr>
                    <?php } ?>
                </table>
                <div class="col-2">
