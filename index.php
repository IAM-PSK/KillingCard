        ...
        <div class="carousel-inner">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid " src="/quillingcards/image/chinese1.png">
                        </div>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="/quillingcards/image/christmas.png">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="/quillingcards/image/father.png">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="shop.php"><img src="/Quillingcards/image/val.jpg" class="rounded-circle img-fluid border"></a>
            ...
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="shop.php"><img src="/quillingcards/image/hnyc.jpg" class="rounded-circle img-fluid border"></a>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    ...
                    <a href="shop.php"><img src="/quillingcards/image/valen.jpg" class="card-img-top">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop.php">
                            <img src="/quillingcards/image/frame.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop.php">
                            <img src="/quillingcards/image/flower.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                            ...
                            <a href="shop-single.php" class="h2 text-decoration-none text-light">ดอกไม้ตกเเต่งห้อง</a>
                            <p class="card-text">
