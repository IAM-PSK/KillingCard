        ...
        <div class="table-responsive mt-2">
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              <?php
                require 'config.php';
                $stmt = $conn->prepare('SELECT * FROM cart  inner join tb_product on cart.product_code = tb_product.product_code LEFT JOIN tb_image on cart.product_code = tb_image.product_id');
                $stmt->execute();
              ...
              <tr>
                ...
                <td>&nbsp;&nbsp;<?= number_format($row['price']*$row['qty'],2); ?> บาท</td>
                <td>
